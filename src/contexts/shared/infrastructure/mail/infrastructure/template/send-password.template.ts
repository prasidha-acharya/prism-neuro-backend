...
export const SendPasswordToUserTemplate = ({ email, password }: ISendPasswordToUserRequest): string =>
  `
                    ...
                    <tbody>
                      <tr>
                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:20px;word-break:break-word;">
                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:22px;font-weight:bold;line-height:1;text-align:center;color:#212121;">Login Credentails</div>
                        </td>
                      </tr>
                      <tr>
