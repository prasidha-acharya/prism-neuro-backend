...
// import { PrismaUserRepository } from 'src/contexts/prism-neuro/users/infrastructure/repositories/prisma-users-repository';
...
//     try {
//       // const response: any = await this.prismaUserRepository.getUser({ userId });
//       console.log('🚀 ~ GetModeSessionActivityOfPatientByPhysioController ~ invoke ~ res:', response.patients.patientModeSession);
